...
public class TC_Service_Get_Otp extends TestBase{
	...
	public TC_Service_Get_Otp(String id) {
		this.id=id;
	}
	...
	{	
		...
		{
			Assert.assertTrue(responseResult.contains("should not be empty") || responseResult.startsWith("invalid") || responseResult.contains("not found"));
		}
		else 
		{
